"""
Django settings for twitter_assingn project.
...
SECRET_KEY = 'django-insecure-l#mzme1z#rc0^$z63(g=boek^$+r8+y7wbe==h38gt^p8o5$iy'
...
WSGI_APPLICATION = 'twitter_assingn.wsgi.application'
